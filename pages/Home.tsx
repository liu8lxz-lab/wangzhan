  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-brand-900 to-brand-800 text-white overflow-hidden">
        {/* Updated Hero Background: High tech lab researcher */}
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1581093588401-fbb07365f5e1?auto=format&fit=crop&q=80&w=1920')] opacity-20 bg-cover bg-center"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              {/* Updated Team Image: Medical research team discussion */}
              <img src="https://images.unsplash.com/photo-1559757175-5700dde675bc?auto=format&fit=crop&q=80&w=800" alt="Medical Team" className="rounded-2xl shadow-2xl" />
            </div>
